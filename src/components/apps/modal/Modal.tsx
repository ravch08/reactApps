...
const Modal = ({ closeModal }: closeModalProp) => {
  return ReactDOM.createPortal(
    <div className="absolute left-1/2 top-1/2 z-10 flex w-1/2 -translate-x-1/2 -translate-y-1/2 flex-col items-start rounded-md bg-amber-300 p-4">
      <h2>Main Modal Title</h2>
      <p>
      ...
      <button onClick={closeModal} className="btn-link mt-8">
        Close
      </button>
    </div>,
